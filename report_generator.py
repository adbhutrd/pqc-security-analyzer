...
<div class="footer">
    ...
    <p style="margin-top: 5px;">Researcher: Enish Shah &bull; MSc Cybersecurity, University of West London</p>
</div>
...
def generate_markdown_report(
    ...
    lines.append(f"*Researcher: Enish Shah, MSc Cybersecurity, University of West London*")
